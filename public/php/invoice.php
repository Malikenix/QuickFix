...
@page { margin: 0; }
    ...
    $query1 = "SELECT * FROM `hire_master` WHERE `hire_id` = $hire_id";
...
<div style=" padding:70px;">
        <img src="../img/black-logo.jpg" alt="Invoice" style="width: 200px;px;"/><br><br>
      ...
      <article>
        ...
        <table class="meta">
          <tr>
            ...
            <td><span contenteditable>' . $hire_id . '</span></td>
          </tr>
          <tr>
            <th><span contenteditable>Order Date</span></th>
            <td><span contenteditable>' . $real_hire_date . '</span></td>
          </tr>
          <tr>
            <th><span contenteditable>Booking Delivery Date</span></th>

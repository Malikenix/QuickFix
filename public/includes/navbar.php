...
<nav class="navbar navbar-expand-lg navbar-dark bg-c1-1 sticky-top">
    ...
    <a class="navbar-brand" href="admin/index.php"> <img src="img/mainlogo.png" style="width:120px;" alt="Logo"> </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="dropdown-menu ">
                    ...
                    if ($result) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<a class="dropdown-item" href="serviceshows.php?category_id=' . $category_id . '">' . $category_name . '</a>';
                        }
                    } else {
                        echo 'note inserted';
                    }
        ...
        <form class="form-inline my-2 my-lg-0">
            ...
            <div class="cart">
                ...
                <a href="../Qfixed-home-service/mylisting.php"><img src="img/clipboard.png" style="width:35px;" alt=""></a>
            </div>

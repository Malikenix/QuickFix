...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <?php
            if (!isset($_SESSION['list']) || $_SESSION['list'] != true) {
            ?>
                    ...
                    <div class="row align-self-center">
                        <div class="col-md-12">
                            <div class="card" style="border:none;">
                                ...
                                <div class="card-body">
                                    <div class="col-sm-12 empty-list-cls text-center">
                                        <!-- <img src="https://i.imgur.com/dCdflKN.png" width="130" height="130" class="img-fluid mb-4 mr-3"> -->
                                        <img src="img/no-task.png" width="130" height="130" class="img-fluid mb-4 mr-3">
                                        <h3><strong>Your Listing is Empty</strong></h3>
                                        <h5 class="text-secondary">You will find a lot of interesting services on our "Service" page :)</h5>
                                        <a href="index.php" class="btn btn-c1-1 list-btn-transform m-3" data-abc="true">continue listing</a>
                        ...
                        <tbody class="text-center">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <small7>&#8369;</small7><?php echo $value['price']; ?>
                    ...
                    <div class="border bg-light rounded p-4">
                        ...
                        ?>
                            <form action="order.php" method="post">
                                ...
                                <br>
                                <button class="btn btn-primary btn-block" name="order">Contact Service provider</button>
                            </form>
                        <?php
                        }
                        ?>

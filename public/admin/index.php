            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-3">
                <div class="bg-theme border shadow">
                    <div class="media p-4">
                        ...
                        <div class="media-body pl-2">
                            <?php
                            $bookquery = "SELECT COUNT(hire_id) AS num_book FROM hire_master";
                            $bookqueryresult = mysqli_query($conn, $bookquery);
                            if ($bookqueryresult) {
                                while ($row2 = mysqli_fetch_assoc($bookqueryresult)) {
                                    $num_book = $row2['num_book'];
                                }
                            }
                            ?>
                            <h3 class="mt-0 mb-0"><strong><?php echo $num_book ?></strong></h3>
                            <p><small class="text-white bc-description">Total Book</small></p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="media-body pl-2">
                            ...
                            $repeatcustomer = "SELECT COUNT(*) AS num_repeat_customers
                                FROM (
                                  ...
                                  HAVING COUNT(DISTINCT hire_date) > 1
                                ) AS repeat_customers";

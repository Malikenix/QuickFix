        ...
        <div class="row pl-0">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-3">
                <div class="bg-white border shadow">
                    <div class="media p-4">
                        ...
                        <div class="media-body pl-2">
                            <?php
                            $pendinghire = "SELECT COUNT(`status`) AS num_status FROM hire_service where `status` = 'pending' AND sp_id = $sp_id";
                            $pendingresult = mysqli_query($conn, $pendinghire);
                            if ($pendingresult) {
                            ...
                            ?>
                            <p><small class="text-muted bc-description">Pending Service</small></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-3">
                <div class="bg-white border shadow">
                    <div class="media p-4">
                        ...
                        <div class="media-body pl-2">
                            <?php
                            $rejectedhire = "SELECT COUNT(`status`) AS num_rejected FROM hire_service where `status` = 'rejected' AND sp_id = $sp_id";
                            $rejectedresult = mysqli_query($conn, $rejectedhire);
                            if ($rejectedresult) {
                            ...
                            <p><small class="text-muted bc-description">Rejected Services</small></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white border shadow">
                    <a href="sp_view.php">
                        <div class="media p-4">
                            ...
                            <div class="media-body pl-2">
                                <?php
                                $completehire = "SELECT COUNT(`status`) AS num_status FROM hire_service where `status` = 'completed' AND sp_id = $sp_id";
                                $completeresult = mysqli_query($conn, $completehire);
                                if ($completeresult) {
                                ...
                                ?>
                                <p><small class="text-muted bc-description">Complete Services</small></p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-3">
                <div class="bg-theme border shadow">
                    <div class="media p-4">
                        ...
                        <div class="media-body pl-2">
                            <?php
                            $total = "SELECT SUM(price) AS total_revenue FROM hire_service where sp_id = $sp_id";
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 card-pro mb-3">
                <div class="card shadow">
                    <div class="card-body">
                        <!-- <h5 class="card-title bc-header">Service wise hires</h5> -->
                        <strong><span class="text-theme">Service</span></strong>
                        <strong><span class="text-theme pull-right">Listing</span></strong>
                        ...
                        $serviceHire= "SELECT service_id, count(service_id) AS num_order_services
                                        FROM Hire_service
                                        WHERE sp_id = $sp_id
                                        GROUP BY service_id";
                        $serviceOrdeRresult = mysqli_query($conn, $serviceHire);

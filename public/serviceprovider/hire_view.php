...
<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
    <div class="row ">
        <div class="col-lg-5">
            <h5 class="mb-0"><strong>Book</strong></h5>
            <span class="text-secondary">Workspace<i class="fa fa-angle-right"></i> Book</span>
        </div>
                    ...
                    <div class="table-responsive product-list">
                        <table class="table table-bordered table-striped mt-3" id="productList">
                            ...
                            <tbody>
                                ...
                                $query1 = "SELECT * FROM `hire_master` WHERE `hire_id` IN (SELECT `hire_id` FROM `hire_service` WHERE sp_id = $sp_id)";
                                ...
                                if ($result1) {
                                    while ($row1 = mysqli_fetch_assoc($result1)) {
                                        ...
                                        $total = $row1['total'];
                                        $fake_hire_date = $row1['hire_date'];
                                        $hire_date = date('j F, Y g:i A', strtotime($fake_hire_date));
                                ...
                                ?>
                                        ...
                                        <tr>
                                            <td class="align-middle"><?php echo $hire_id ?></td>
                                            ...
                                            <td class="align-middle"><?php echo $hire_date ?></td>
                                            <td class="align-middle"><?php echo $due_date ?></td>

                                                <td class="align-middle text-center">

                                                <a href="hire_details.php?hire_id=<?php echo $hire_id ?>&sp_id=<?php echo $sp_id ?>"><button class="btn btn-theme mb-2" title="See Hire Details">
                                                        <i class="fa fa-eye"></i>
                                                    </button>
                                                </a>

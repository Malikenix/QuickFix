                    ...
                    <div class="col-lg-10 col-xl-8">
                        <div class="card" style="border-radius: 10px;">
                            <div class="card-header px-4 py-5" style="background-color: #227c70;">
                                ...
                                <center>
                                    <img src="../img/done_100.svg" alt="service_done" srcset="">
                                    <h4 class="text-light mb-0">Thanks for the Services, <u><?php echo $_SESSION['username'] ?></u>!</h4>
                                </center>
                                <!-- <h5 class="text-muted mb-0">Thanks for your service, <span style="color: #a8729a;"><?php echo $_SESSION['username'] ?></span>!</h5> -->
                            </div>
                            <div class="card-body p-4">
                                <center>
                                        <form action="../php/invoice.php" method="post">
                                            <?php
                                            if (isset($_GET['hire_id']) && isset($_GET['customer_id'])) {
                                        ...
                                        <br>
                                            <a href="service_details.php"><button class="btn btn-c1-1">Service status</button></a>
                                ...
                                <!-- <div class="card shadow-0 border mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="row d-flex align-items-center">
                                            <div class="col-md-2">
                                                <p class="text-muted mb-0 small">Track Service</p>
                                            </div>
                                            <div class="col-md-10">
                            ...
                            <!-- <div class="card-footer border-0 px-4 py-5" style="background-color: #227c70; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
                            <a><button class="btn btn-c1-1">Invoice</button></a>
                            <a><button class="btn btn-c1-1">Order status</button></a>
                                <h5 class="d-flex align-items-center justify-content-end text-white text-uppercase mb-0">Total
                                    paid: <span class="h2 mb-0 ms-2">$1040</span>
                                </h5>
                            </div> -->
                        </div>
                    </div>
